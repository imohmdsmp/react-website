...
const NFTDetails = () => {
  ...
  const [dataNFTDetail, setDataNFTDetail] = useState({
    title: null,
    caption: null,
    image_path: null,
  });
  useEffect(() => {
    axiosInstance
      .get(`/v1/nft/collection/details?nft_id=${pathUser[2]}`)
      .then((response) => {
        setDataNFTDetail(response.data.data);
      });
  }, []);
            ...
            <div className="row">
              <div className="col-12 col-md-6">
                <div className="content-left">
                  <div className="media">
                    <img src={dataNFTDetail.json.image} />
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="content-right">
                  <div className="sc-item-details">
                    <h2 className="style2">{dataNFTDetail.json.name}</h2>
                        ...
                        <div className="meta-info">
                          <div className="author">
                            <div className="avatar">
                              <img src={dataNFTDetail.user.avatar} />
                            </div>
                            <div className="info">
                              <span>Creator</span>
                              <h6>
                    ...
                    <p>{dataNFTDetail.json.description}</p>
