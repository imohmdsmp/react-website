...
const Followers = () => {
  ...
  useEffect(() => {
    axiosInstance
      .get(`/v1/follow/followers?username=${pathUser[2]}`, {
        headers: {
          Authorization: "bearer " + localStorage.getItem("access_token"),
        },
      })
      .then((response) => {
        setListFlws(response.data.data);
      });
  }, []);
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="page-title-heading mg-bt-12">
                <h1 className="heading text-center">Followers</h1>
              </div>
        ...
        <div className="themesflat-container">
          <div className="row">
            <div className="col-lg-8 col-md-8 col-12">
              {listFlws ? (
                listFlws.slice(0, visible).map((item, index) => (
                  <Link
